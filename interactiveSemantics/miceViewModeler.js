...
MiceViewModeler.createMetadata = function(isRoot, mmd, metadata, taskUrl)
{
  var metadataFields =
	  MiceViewModeler.getMetadataViewModel(mmd, mmd["kids"], metadata,
                                        0, null, taskUrl);
 ...
 */
MiceViewModeler.getMetadataViewModel = function(parentField, mmdKids, metadata, depth,
                                               child_value_as_label, taskUrl)
{
  ...
  {    
    ...
    if (mmdField.scalar)
    {
    	MiceViewModeler.getScalarMetadataViewModel(metadataViewModel, parentField, mmdField,
          mmdKids, metadata, depth, child_value_as_label, taskUrl);
    }    
    else if (mmdField.composite)
    {
    	MiceViewModeler.getCompositeMetadataViewModel(metadataViewModel, parentField, mmdField,
          mmdKids, metadata, depth, child_value_as_label, taskUrl);
    }
    else if (mmdField.collection != null)
    {
    	MiceViewModeler.getCollectionMetadataViewModel(metadataViewModel, parentField, mmdField,
          mmdKids, metadata, depth, child_value_as_label, taskUrl);
    }
  }
  ...
  MiceViewModeler.collapseEmptyLabelSet(metadataViewModel, parentField);
 ...
 *
 */
MiceViewModeler.getScalarMetadataViewModel = function(metadataViewModel,
													 parentField,
                                                     mmdField,
                                                     mmdKids,
                                                     metadata,
                                                     ...
                                                     taskUrl)
{
  ...
  if (MiceViewModeler.isFieldVisible(mmdField, metadata, taskUrl, parentField))
  {        
    // Is there a metadata value for this field?    
    var value = MiceViewModeler.getFieldValue(mmdField, metadata);        
    if (value)
    {  
      ...
      var field = MiceViewModeler.getMetadataField(mmdField, metadataViewModel);
                
      field.value = value;
      if (mmdField.use_value_as_label != null) 
      {
        field.value_as_label =
        	MiceViewModeler.getValueForProperty(mmdField.use_value_as_label,
      ...
      {
        StringCleaner.concatenateField(field, metadataViewModel, mmdKids);
      }
...
MiceViewModeler.getCompositeMetadataViewModel = function(metadataViewModel,
														parentField,
                                                        mmdField,
                                                        mmdKids,
                                                        metadata,
    ...
    {  
      ...
      {            
        for (var i = 0; i < value.length; i++)
        {
          ...
          field.value =
        	  MiceViewModeler.getMetadataViewModel(mmdField, mmdField["kids"], value[i],
          ...
          field.parentMDType = metadata.meta_metadata_name;
          MiceViewModeler.checkAndSetShowExpanded(parentField, field);
      ...
      else
      {
        ...
        field.value =
        	MiceViewModeler.getMetadataViewModel(mmdField, mmdField["kids"], value,
                                              depth + 1, null, taskUrl);
        if (mmdField.use_value_as_label != null)
        {
...
MiceViewModeler.getCollectionMetadataViewModel = function(metadataViewModel,
														 parentField,
                                                         mmdField,
                                                         mmdKids,
                                                         metadata,
                                                         ...
                                                         taskUrl)
{
  ...
  {    
    ...
    {  
      ...
      {
        field.value =
        	MiceViewModeler.getMetadataViewModel(mmdField,
        		  							  mmdField["kids"],
                                              value,
                                              depth + 1,
...
MiceViewModeler.collapseEmptyLabelSet = function(metadataViewModel, parentField)
{
	var deleteLabelCol = true;
	// make deleteLabelCol false if any child label is visible
	for (var i = 0; i < metadataViewModel.length; i++)
	{
		if (MiceViewModeler.isLabelVisible(metadataViewModel[i], parentField))
		{
...
MiceViewModeler.isLabelVisible = function(field, parentField)
{
	if (field.scalar_type)
	{
...
MiceViewModeler.checkAndSetShowExpanded = function(parentField, field)
{
 ...
 */
MiceViewModeler.getMetadataField = function(mmdField, metadataFields)
{
 ...
 * 
 */
MiceViewModeler.isFieldVisible = function(mmdField, metadata, url, parentField)
{
  if (mmdField["styles"])
  {
  ...
  var includeMediaField = MiceViewModeler.isVisibleMediaField(mmdField, parentField);
  
  return includeMediaField || mmdField.hide == null || mmdField.hide == "false" || mmdField.always_show == "true";
}

MiceViewModeler.isVisibleMediaField = function(mmdField, parentField)
{
 ...
 * 
 */
MiceViewModeler.getFieldValue = function(mmdField, metadata)
{
 ...
 * 
 */
MiceViewModeler.getValueForProperty = function(valueAsLabelStr, metadata,
                                              mmdKids, depth, taskUrl)
{
  ...
  else if (fieldValue)
  {
    ...
    {
      var metadataFields =
    	  MiceViewModeler.getMetadataViewModel(mmdField, mmdKids, fieldValue, depth, null,
                                            taskUrl);
 ...
 * 
 */
MiceViewModeler.concatenateField = function(field, metadataFields, mmdKids)
{
  var metadataField = "";  
  for (var i = 0; i < metadataFields.length; i++)
  {
 ...
 *
 */
MiceViewModeler.getImageSource = function(metadataViewModel)
{
  for (var i = 0; i < metadataViewModel.length; i++)
  {
 ...
 */
MiceViewModeler.hasVisibleMetadata = function(metadata)
{
