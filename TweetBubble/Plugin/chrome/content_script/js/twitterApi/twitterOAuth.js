...
TwitterOAuth.createOAuthSignature = function(url, params, oauth_token_secret)
{
...
TwitterOAuth.sendRequest = function(url, callback, auth)
{
...
TwitterOAuth.getRequestToken = function()
{
	...
	var sig = TwitterOAuth.createOAuthSignature(url, params, "");
	params["oauth_signature"] = sig;

	var auth = TwitterOAuth.createAuthorizationHeader(params);
	
	TwitterOAuth.sendRequest(url, TwitterOAuth.handleRequestTokenResponse, auth);
}
...
TwitterOAuth.getAccessToken = function(oauth_token, oauth_token_secret, oauth_verifier)
{
	...
	var sig = TwitterOAuth.createOAuthSignature(url, params, oauth_token_secret);
	params["oauth_signature"] = sig;

	var auth = TwitterOAuth.createAuthorizationHeader(params);
	
	TwitterOAuth.sendRequest(url, TwitterOAuth.handleAccessTokenResponse, auth);
